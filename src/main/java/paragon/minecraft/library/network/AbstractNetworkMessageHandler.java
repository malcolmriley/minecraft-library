...
public abstract class AbstractNetworkMessageHandler<T extends INetworkMessage> implements INetworkMessageHandler<T> {
	...
	@Override
	public void handle(T message, Supplier<Context> contextProvider) {
	...
	/**
	 * This method should execute the action associated with receiving the provided message. This method will be wrapped and executed on an appropriate thread via {@link Context#enqueueWork(Runnable)}.
	 * <p>
